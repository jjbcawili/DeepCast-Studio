      ...
      <div className="page-container home-container">
        <section className="approved-hero" aria-labelledby="hero-title">
          <div className="approved-hero-title">
            ...
            <div className="deep-dive-art" role="img" aria-label="Deep Dive">
              <img src="/assets/18_DeepDive_Standalone_Title_Blue_Transparent_4K.webp" alt="" />
            </div>
        ...
        {!hideDeepDives && (
          <section className={`dashboard-section glass-section deep-dives-section ${openMenu?.kind === "deep-dive" ? "menu-layer-active" : ""}`} aria-labelledby="deep-dives-title">
            <div className="section-heading asset-section-heading"><h2 id="deep-dives-title" className="asset-heading deep-dives-title-art"><Link href="/deep-dives" aria-label="Open Deep Dives"><img src="/assets/18_DeepDive_Standalone_Title_Blue_Transparent_4K.webp" alt="Deep Dives" /></Link></h2></div>
