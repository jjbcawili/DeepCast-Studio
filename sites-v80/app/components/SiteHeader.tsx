    ...
    <>
      <header className="topbar">
        <Link href="/" className="brand" aria-label="DeepCast Studio home">
          <span className="desktop-brand-art" aria-hidden="true"><img src="/assets/02_DeepCast_Studio_Alt_Title_Blue_Transparent_4K.webp" alt="" /></span>
          <span className="mobile-brand-art" aria-hidden="true"><img src="/assets/04_DeepCast_Alt_Emblem_Blue_Transparent_4K.webp" alt="" /></span>
